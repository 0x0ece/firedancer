...
#ifndef HEADER_fd_src_app_shared_commands_run_generated_pidns_arm64_seccomp_h
#define HEADER_fd_src_app_shared_commands_run_generated_pidns_arm64_seccomp_h
...
static void populate_sock_filter_policy_pidns_arm64( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  ...
  struct sock_filter filter[23] = {
    ...
    /* simply allow ppoll */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_ppoll, /* RET_ALLOW */ 16, 0 ),
    /* allow wait4 based on expression */
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_wait4, /* check_wait4 */ 8, 0 ),
