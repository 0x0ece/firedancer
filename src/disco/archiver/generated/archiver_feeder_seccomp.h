...
#ifndef HEADER_fd_src_disco_archiver_generated_archiver_feeder_seccomp_h
#define HEADER_fd_src_disco_archiver_generated_archiver_feeder_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_archiver_feeder_instr_cnt = 14;

static void populate_sock_filter_policy_archiver_feeder( ulong out_cnt, struct sock_filter * out, unsigned int logfile_fd ) {
  FD_TEST( out_cnt >= 14 );
