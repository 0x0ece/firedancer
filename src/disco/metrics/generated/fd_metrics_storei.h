#ifndef HEADER_fd_src_disco_metrics_generated_fd_metrics_storei_h
#define HEADER_fd_src_disco_metrics_generated_fd_metrics_storei_h
...
#endif /* HEADER_fd_src_disco_metrics_generated_fd_metrics_storei_h */
