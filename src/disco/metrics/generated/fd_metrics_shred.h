...
#define FD_METRICS_COUNTER_SHRED_SHRED_OUT_RCV_OFF  (117UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WAIT_OFF  (119UL)
...
#define FD_METRICS_HISTOGRAM_SHRED_STORE_INSERT_WORK_OFF  (136UL)
