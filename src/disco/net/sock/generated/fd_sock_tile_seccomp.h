...
#endif
static const unsigned int sock_filter_policy_fd_sock_tile_instr_cnt = 39;

static void populate_sock_filter_policy_fd_sock_tile( ulong out_cnt, struct sock_filter * out, uint logfile_fd, uint tx_fd, uint rx_fd0, uint rx_fd1 ) {
  FD_TEST( out_cnt >= 39 );
  struct sock_filter filter[39] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_clock_nanosleep, /* check_clock_nanosleep */ 24, 0 ),
