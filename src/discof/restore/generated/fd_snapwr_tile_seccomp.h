...
#ifndef HEADER_fd_src_discof_restore_generated_fd_snapwr_tile_seccomp_h
#define HEADER_fd_src_discof_restore_generated_fd_snapwr_tile_seccomp_h
...
static void populate_sock_filter_policy_fd_snapwr_tile( ulong out_cnt, struct sock_filter * out, uint logfile_fd, uint vinyl_fd ) {
  ...
  struct sock_filter filter[20] = {
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, SYS_pwrite64, /* check_pwrite64 */ 4, 0 ),
...
//  check_pwrite64:
    ...
    BPF_JUMP( BPF_JMP | BPF_JEQ | BPF_K, vinyl_fd, /* RET_ALLOW */ 9, /* RET_KILL_PROCESS */ 8 ),
//  check_write:
    /* load syscall argument 0 in accumulator */
    BPF_STMT( BPF_LD | BPF_W | BPF_ABS, offsetof(struct seccomp_data, args[0])),
