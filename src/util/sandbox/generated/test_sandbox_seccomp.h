...
#ifndef HEADER_fd_src_util_sandbox_generated_test_sandbox_seccomp_h
#define HEADER_fd_src_util_sandbox_generated_test_sandbox_seccomp_h
...
#endif
static const unsigned int sock_filter_policy_test_sandbox_instr_cnt = 15;

static void populate_sock_filter_policy_test_sandbox( ulong out_cnt, struct sock_filter * out ) {
  FD_TEST( out_cnt >= 15 );
